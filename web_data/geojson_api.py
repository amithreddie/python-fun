...
# and parse that data, and retrieve the first place_id from the JSON. A place 
# ID is a textual identifier that uniquely identifies a place as within 
# Google Maps.
...
# using the urllib.urlencode() fuction as shown in http://www.pythonlearn.com/code/geojson.py
