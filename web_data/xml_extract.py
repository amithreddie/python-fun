...
# http://www.pythonlearn.com/code/geoxml.py. The program will prompt for a 
# URL, read the XML data from that URL using urllib and then parse and extract 
...
# Actual data: http://python-data.dr-chuck.net/comments_282732.xml (Sum ends 
# with 0)
...
url = 'http://python-data.dr-chuck.net/comments_282732.xml?'
...
total = 0
for r in results:
    total = total + int(r.find('count').text)
